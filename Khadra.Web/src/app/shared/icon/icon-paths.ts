// Line-icon set ported from the dashboard (itself from the Claude Design project's icons.js),
// plus the few the customer website needs that the consoles never did (heart, seat, fuel, QR...).
...
export const ICON_PATHS: Readonly<Record<IconName, string>> = Object.freeze({
  ...
  'heart': '<path d="M12 20s-7.5-4.4-7.5-10A4.5 4.5 0 0 1 12 7.3 4.5 4.5 0 0 1 19.5 10c0 5.6-7.5 10-7.5 10Z"/>',
  'heart-fill': '<path fill="currentColor" d="M12 20s-7.5-4.4-7.5-10A4.5 4.5 0 0 1 12 7.3 4.5 4.5 0 0 1 19.5 10c0 5.6-7.5 10-7.5 10Z"/>',
  'gas-pump': '<path d="M4.5 20.5v-15a2 2 0 0 1 2-2h5a2 2 0 0 1 2 2v15M3 20.5h12M4.5 10h9M13.5 8.5l3 0 2.5 2.5v6.5a1.5 1.5 0 0 1-3 0V14h-2.5"/>',
  'seat': '<path d="M7 4.5h5a1.5 1.5 0 0 1 1.5 1.6l-.6 7.4H18a1.5 1.5 0 0 1 1.5 1.5v1.5H7.5L6 6.2A1.5 1.5 0 0 1 7 4.5ZM9 16.5v4M17 16.5v4"/>',
  ...
  'qr-code': '<rect x="4" y="4" width="6" height="6" rx="1"/><rect x="14" y="4" width="6" height="6" rx="1"/><rect x="4" y="14" width="6" height="6" rx="1"/><path d="M14 14h2.5v2.5H14zM17.5 17.5H20V20h-2.5zM14 19.5h1.5M19.5 14v1.5"/>',
  'truck': '<path d="M2.5 6.5h11v10h-11zM13.5 10h4l3 3.2v3.3h-7"/><circle cx="6.5" cy="17.5" r="1.8"/><circle cx="16.5" cy="17.5" r="1.8"/>',
  'arrow-right': '<path d="M4.5 12h15M13.5 6l6 6-6 6"/>',
  'arrow-left': '<path d="M19.5 12h-15M10.5 6l-6 6 6 6"/>',
  'phone': '<path d="M5 4h3.5l1.7 4.2-2.2 1.4a11 11 0 0 0 6.4 6.4l1.4-2.2L20 15.5V19a1.5 1.5 0 0 1-1.6 1.5A16 16 0 0 1 3.5 5.6 1.5 1.5 0 0 1 5 4Z"/>',
  'upload-simple': '<path d="M12 15.5V4.5M7.5 9 12 4.5 16.5 9M4.5 19.5h15"/>',
  'file-text': '<path d="M14 3.5H7a1.5 1.5 0 0 0-1.5 1.5v14A1.5 1.5 0 0 0 7 20.5h10a1.5 1.5 0 0 0 1.5-1.5V8L14 3.5Z"/><path d="M14 3.5V8h4.5M9 12.5h6M9 16h6"/>',
});
