...
namespace Khadra.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923010807_PushDevicesAndPreferredLanguage")]
    partial class PushDevicesAndPreferredLanguage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Khadra.Domain.Auditing.DocumentAccessEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_document_access_entries");

                    b.HasIndex("BookingId", "OccurredAt")
                        .HasDatabaseName("ix_document_access_entries_booking_id_occurred_at");

                    b.HasIndex("DealerId", "OccurredAt", "Id")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("ix_document_access_entries_dealer_id_occurred_at_id");

                    b.HasIndex("SubjectUserId", "OccurredAt", "Id")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("ix_document_access_entries_subject_user_id_occurred_at_id");

                    b.ToTable("document_access_entries", (string)null);
                });
            ...
            modelBuilder.Entity("Khadra.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("HoldStart")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("Khadra.Domain.Bookings.RenterDocumentReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_renter_document_reviews");

                    b.HasIndex("BookingId", "DocumentId", "DocumentUploadedAt")
                        .IsUnique()
                        .HasDatabaseName("ix_renter_document_reviews_booking_id_document_id_document_upl");

                    b.ToTable("renter_document_reviews", (string)null);
                });
            ...
            modelBuilder.Entity("Khadra.Domain.Fleet.Vehicle", b =>
                {
                    ...
                    b.Property<string>("FuelPolicy")
                        ...
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("fuel_policy");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean")
                        .HasColumnName("is_deleted");

                    b.Property<bool>("IsDeliveryEligible")
                        .HasColumnType("boolean")
                        .HasColumnName("is_delivery_eligible");
            ...
            modelBuilder.Entity("Khadra.Domain.Fleet.VehicleImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("VehicleId", "Position")
                        .HasDatabaseName("ix_vehicle_images_vehicle_id_position");

                    b.ToTable("vehicle_images", (string)null);
                });

            modelBuilder.Entity("Khadra.Domain.IdentityAccess.CustomerDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId", "Type")
                        .IsUnique()
                        .HasDatabaseName("ix_customer_documents_user_id_type");
            ...
            modelBuilder.Entity("Khadra.Domain.IdentityAccess.User", b =>
                {
                    ...
                    b.Property<bool>("IsForeignNational")
                        .HasColumnType("boolean")
                        .HasColumnName("is_foreign_national");
            ...
            modelBuilder.Entity("Khadra.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RecipientUserId", "OccurredAt", "Id")
                        .IsDescending(false, true, true)
            ...
            modelBuilder.Entity("Khadra.Domain.PlatformSettings.CarType", b =>
                {
                    ...
                    b.HasIndex("DisplayOrder", "NameEn")
                        .HasDatabaseName("ix_car_types_display_order_name_en");
            ...
            modelBuilder.Entity("Khadra.Domain.PlatformSettings.City", b =>
                {
                    ...
                    b.HasIndex("DisplayOrder", "NameEn")
                        .HasDatabaseName("ix_cities_display_order_name_en");
                            ...
                            b1.OwnsOne("Khadra.Domain.Fleet.MileagePolicy", "Mileage", b2 =>
                                {
                                    ...
                                    b2.Property<int?>("DailyLimitKm");

                                    b2.Property<bool>("IsUnlimited");
                    ...
                    b.OwnsOne("Khadra.Domain.Bookings.BookingTerms", "Terms", b1 =>
                        {
                            ...
                            b1.Property<TimeSpan>("PostReturnSettlementWindow");

                            b1.Property<int>("RulesVersion");

                            b1.Property<TimeSpan>("TurnaroundBuffer");
            ...
            modelBuilder.Entity("Khadra.Domain.Dealers.Dealer", b =>
                {
                    ...
                    b.OwnsOne("Khadra.Domain.Dealers.DealerAddress", "Address", b1 =>
                        {
                            b1.Property<Guid>("DealerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Khadra.Domain.Dealers.PublicProfile", "PublicProfile", b1 =>
                        {
                            ...
                            b1.Property<string>("CustomerNotesAr")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("customer_notes_ar");

                            b1.Property<string>("CustomerNotesEn")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("customer_notes_en");

                            b1.Property<string>("DeliveryNotesAr")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("delivery_notes_ar");

                            b1.Property<string>("DeliveryNotesEn")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                            ...
                            b1.Property<string>("InsuranceAr")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("insurance_summary_ar");

                            b1.Property<string>("InsuranceEn")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("insurance_summary_en");

                            b1.Property<string>("PickupInstructionsAr")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("pickup_instructions_ar");

                            b1.Property<string>("PickupInstructionsEn")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("pickup_instructions_en");

                            b1.Property<string>("RentalConditionsAr")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                                .HasColumnName("rental_conditions_ar");

                            b1.Property<string>("RentalConditionsEn")
                                .HasMaxLength(2000)
                                .HasColumnType("character varying(2000)")
                            ...
                            b1.OwnsOne("Khadra.Domain.Disputes.DepositDisposition", "Deposit", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("Khadra.Domain.Common.Money", "DepositHeld", b3 =>
                                        {
            ...
            modelBuilder.Entity("Khadra.Domain.Fleet.Vehicle", b =>
                {
                    b.OwnsOne("Khadra.Domain.Common.Money", "DailyRate", b1 =>
                        {
                    ...
                    b.OwnsOne("Khadra.Domain.Fleet.MileagePolicy", "Mileage", b1 =>
                        {
                            b1.Property<Guid>("VehicleId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<int?>("DailyLimitKm")
                                .HasColumnType("integer")
                                .HasColumnName("mileage_daily_limit_km");

                            b1.Property<bool>("IsUnlimited")
                                .HasColumnType("boolean")
                                .HasColumnName("mileage_unlimited");
                            ...
                            b1.OwnsOne("Khadra.Domain.Common.Money", "ExcessFeePerKm", b2 =>
                                {
                                    b2.Property<Guid>("MileagePolicyVehicleId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("id");
                                    ...
                                    b2.Property<decimal>("Amount")
                                        .HasPrecision(18, 3)
                                        .HasColumnType("numeric(18,3)")
                                        .HasColumnName("mileage_excess_fee");

                                    b2.Property<string>("CurrencyCode")
                                        .IsRequired()
                                        .HasMaxLength(3)
                                        .HasColumnType("character varying(3)")
                                        .HasColumnName("mileage_excess_currency");

                                    b2.HasKey("MileagePolicyVehicleId");

                                    b2.ToTable("vehicles");

                                    b2.WithOwner()
                                        .HasForeignKey("MileagePolicyVehicleId")
                                        .HasConstraintName("fk_vehicles_vehicles_id");
                                });

                            b1.Navigation("ExcessFeePerKm");
                        });

                    b.OwnsOne("Khadra.Domain.Common.Money", "SecurityDeposit", b1 =>
                        {
                            b1.Property<Guid>("VehicleId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Khadra.Domain.Fleet.VehicleDetails", "Details", b1 =>
                        {
                            b1.Property<Guid>("VehicleId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Khadra.Domain.Common.GeoPoint", "Centre", b1 =>
                        {
                            ...
                            b1.Property<double>("Latitude")
                                .HasColumnType("double precision")
                                .HasColumnName("centre_latitude");

                            b1.Property<double>("Longitude")
                                .HasColumnType("double precision")
                                .HasColumnName("centre_longitude");
            ...
            modelBuilder.Entity("Khadra.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.Navigation("RenterDocumentReviews");
